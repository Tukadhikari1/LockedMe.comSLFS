...
File directory = new File("C:\\Users\\user\\Desktop\\Locked Me Application 1st Project SL//");

		String[] flist  = directory.list();

		// Take user Option from the below mentioned Menu
		Scanner input = new Scanner(System.in);
		System.out.println("********Wellcome to simplilear first assissment**********");
		System.out.println("******* Simplilearn locckedMe.com ********");
		System.out.println("********Prototype Application********");
		System.out.println("******* Tuk Adhikari *********************");

		System.out.println("*****************************************");
		System.out.println("******* Simplilearn Full Stack Developer  ************");
		System.out.println();
		...
		do {
			...
			try {
            File file = new File("C:\\Users\\user\\Desktop\\Locked Me Application 1st Project SL//");
...
File directory_delete = new File("C:\\Users\\user\\Desktop\\Locked Me Application 1st Project SL//");
...
File file = new File("C:\\Users\\user\\Desktop\\Locked Me Application 1st Project SL//" + delete_filename);
		    if (file.delete()) {
			...
			filename = input.next();
File directory_search = new File("C:\\Users\\user\\Desktop\\Locked Me Application 1st Project SL//");
	...
	private static void listOfFiles() {
		...
		File folder = new File("C:\\Users\\user\\Desktop\\Locked Me Application 1st Project SL//");
